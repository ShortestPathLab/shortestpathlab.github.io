...
<Grid class="not-prose my-4 gap-8" width={200}>
    ...
    member={{
      title: "Kostas Bekris",
      description: "Rutgers University",
      image: "https://github.com/MAPF-Competition/web_resource/blob/develop/external_page_resource/organisers/bekris_2018_01_small.jpg?raw=true",
    }}
  />
  ...
  <MemberCard
    member={{
      ...
      image: "https://github.com/MAPF-Competition/web_resource/blob/develop/external_page_resource/organisers/fede-pic.jpeg?raw=true",
    }}
  />
</Grid>
