...
description: A project to bridge the gap between theoretical MAPF solutions and real-world robot operation using TurtleBot 4.
image: /assets/previews/ros.png
featured: true
tags: [multiagent, robotics, summerresearch]
dark: false
---
