...
## Best system demonstration at ICAPS24

We're so excited to announce that Posthoc has won the best system demonstration award at [The 34th International Conference on Automated Planning and Scheduling](https://icaps24.icaps-conference.org/program/demos/). Check out the demo video we produced for this conference.

<iframe
  class="aspect-[16/10] w-full rounded-md"
  src="https://www.youtube.com/embed/Nz2_Z9hqrmM?si=q5zFvM2feo1A3rIn"
